...
class Ui_manage_window(object):
    def setupUi(self, manage_window):
        ...
        self.label.setGeometry(QtCore.QRect(290, 30, 231, 31))
        font = QtGui.QFont()
        ...
        self.loss_logout_btn.setGeometry(QtCore.QRect(500, 280, 120, 61))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        ...
        self.infos_btn.setGeometry(QtCore.QRect(140, 280, 110, 61))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.back_btn.setGeometry(QtCore.QRect(340, 430, 110, 61))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.change_pwd_btn.setGeometry(QtCore.QRect(500, 150, 90, 21))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        ...
        self.frame.setGeometry(QtCore.QRect(110, 270, 521, 81))
        self.frame.setFrameShape(QtWidgets.QFrame.Box)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.back_btn_2 = QtWidgets.QPushButton(self.frame)
        self.back_btn_2.setGeometry(QtCore.QRect(210, 10, 110, 61))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.label.raise_()
        self.loss_logout_btn.raise_()
        self.infos_btn.raise_()
        self.back_btn.raise_()
        self.change_pwd_btn.raise_()
    ...
    def retranslateUi(self, manage_window):
        ...
        manage_window.setWindowTitle(_translate("manage_window", "校园卡管理系统"))
        self.label_2.setText(_translate("manage_window", "你好，管理员："))
        self.label.setText(_translate("manage_window", "校园卡管理系统"))
        ...
        self.back_btn_2.setText(_translate("manage_window", "统计信息"))
